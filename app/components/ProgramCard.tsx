...
export default function ProgramCard({
  ...
  return (
    ...
    >
      ...
      />
      <div className="pointer-events-none absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-black/70 via-black/10 via-35% to-transparent p-5 text-white transition-colors duration-300 group-hover:from-[#EE0076]/90 group-hover:via-[#EE0076]/25 group-focus-visible:from-[#EE0076]/90 group-focus-visible:via-[#EE0076]/25">
